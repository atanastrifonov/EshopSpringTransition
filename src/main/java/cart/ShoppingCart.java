...
public class ShoppingCart {
     ...
     */
    public synchronized void addItem(ProductData productData) {
        ...
        if (newItem) {
            ShoppingCartItem scItem = new ShoppingCartItem(productData);
            items.add(scItem);
        }
    }
    ...
    public synchronized double getSubtotal() {
        ...
        for (ShoppingCartItem scItem : items) {
            ...
            ProductData productData = (ProductData) scItem.getProduct();
            amount += (scItem.getQuantity() * productData.getPrice().doubleValue());
        }
