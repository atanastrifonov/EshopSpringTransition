...
@NamedQueries({
    ...
    @NamedQuery(name = "OrderedProduct.findByLineItemId", query = "SELECT o FROM OrderedProduct o WHERE o.orderedProductPK.lineItemId = :lineItemId"),
...
public class OrderedProduct implements Serializable {
    ...
    @JoinColumn(name = "line_item_id", referencedColumnName = "id", insertable = false, updatable = false)
    @ManyToOne(optional = false)
    ...
    public OrderedProduct(int customerOrderId, int lineItemId) {
        this.orderedProductPK = new OrderedProductPK(customerOrderId, lineItemId);
    }
